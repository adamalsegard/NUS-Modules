...
// COMMENTS TO GRADER:
// - On my laptop: (with submitted constants)
// - Scene 1 takes ~0.8s
// - Scene 2 takes ~11.5s
// - Bonus scene takes ~1.4s
//
// ============================================================
//
// FILE: Main.cpp
...
// Constants for Bonus scene.
static const int imageWidth3 = 640;
static const int imageHeight3 = 480;
static const int maxDepth = 5;
static const int hasShadow3 = true;


// Some refraction indexes
...
const double REFRACTION_BUBBLE = 1.02; // For some slight distorsions


///////////////////////////////////////////////////////////////////////////
// Raytrace the whole image of the scene and write it to a file.
///////////////////////////////////////////////////////////////////////////
void RenderImage(const char *imageFilename, const Scene &scene, int recursionDepth, bool hasShadow)
{
	...
	for (int y = 0; y < imgHeight; y++)
	{
		...
		for (int x = 0; x < imgWidth; x++)
		{
			...
			Color pixelColor = Raytrace::TraceRay(ray, scene, recursionDepth, hasShadow);
			pixelColor.clamp();
...
void DefineBonusScene(Scene &scene, int imageWidth, int imageHeight);
...
int main()
{
	...
	Scene scene3;
	DefineBonusScene(scene3, imageWidth3, imageHeight3);

	// Render Bonus Scene.

	printf("Render Bonus Scene...\n");
	RenderImage("out3.png", scene3, maxDepth, hasShadow3);
	printf("Image completed.\n");
...
void DefineScene1(Scene &scene, int imageWidth, int imageHeight)
{
	...
	scene.material[0].k_t = Color(0.0f, 0.0f, 0.0f);
	scene.material[0].k_tg = Color(0.0f, 0.0f, 0.0f);
	scene.material[0].m = 2.0f;
	scene.material[0].u = 1.0f;
	...
	scene.material[1].k_t = Color(0.0f, 0.0f, 0.0f);
	scene.material[1].k_tg = Color(0.0f, 0.0f, 0.0f);
	scene.material[1].m = 2.0f;
	scene.material[1].u = 1.0f;
	...
	scene.material[2].k_t = Color(0.0f, 0.0f, 0.0f);
	scene.material[2].k_tg = Color(0.0f, 0.0f, 0.0f);
	scene.material[2].m = 2.0f;
	scene.material[2].u = 1.0f;
	...
	scene.material[3].k_t = Color(0.0f, 0.0f, 0.0f);
	scene.material[3].k_tg = Color(0.0f, 0.0f, 0.0f);
	scene.material[3].m = 2.0f;
	scene.material[3].u = 1.0f;
	...
	scene.material[4].k_t = Color(0.0f, 0.0f, 0.0f);
	scene.material[4].k_tg = Color(0.0f, 0.0f, 0.0f);
	scene.material[4].m = 2.0f;
	scene.material[4].u = 1.0f;
...
void DefineScene2(Scene &scene, int imageWidth, int imageHeight, bool rubics)
{
	...
	scene.material[5].k_t = Color(0.0f, 0.0f, 0.0f);
	scene.material[5].k_tg = Color(0.0f, 0.0f, 0.0f);
	scene.material[5].m = 2.0f;
	scene.material[5].u = 1.0f;
	...
	scene.material[6].k_t = Color(0.0f, 0.0f, 0.0f);
	scene.material[6].k_tg = Color(0.0f, 0.0f, 0.0f);
	scene.material[6].m = 2.0f;
	scene.material[6].u = 1.0f;
	...
	scene.material[7].k_t = Color(0.0f, 0.0f, 0.0f);
	scene.material[7].k_tg = Color(0.0f, 0.0f, 0.0f);
	scene.material[7].m = 2.0f;
	scene.material[7].u = 1.0f;
	...
	scene.material[8].k_t = Color(0.0f, 0.0f, 0.0f);
	scene.material[8].k_tg = Color(0.0f, 0.0f, 0.0f);
	scene.material[8].m = 2.0f;
	scene.material[8].u = 1.0f;
	...
	scene.material[9].k_t = Color(0.0f, 0.0f, 0.0f);
	scene.material[9].k_tg = Color(0.0f, 0.0f, 0.0f);
	scene.material[9].m = 2.0f;
	scene.material[9].u = 1.0f;
	...
	scene.material[10].k_t = Color(0.0f, 0.0f, 0.0f);
	scene.material[10].k_tg = Color(0.0f, 0.0f, 0.0f);
	scene.material[10].m = 2.0f;
	scene.material[10].u = 1.0f;
...
void DefineBonusScene(Scene &scene, int imageWidth, int imageHeight)
{
	...
	scene.amLight.I_a = Color(0.8f, 0.8f, 1.0f) * 0.15f;

	// Define materials.

	scene.numMaterials = 7;
	scene.material = new Material[scene.numMaterials];

	// Light red - reflective
	scene.material[0].k_d = Color(0.8f, 0.4f, 0.4f);
	scene.material[0].k_a = scene.material[0].k_d;
	scene.material[0].k_r = Color(0.8f, 0.8f, 0.8f) * 0.6f;
	scene.material[0].k_rg = Color(0.8f, 0.8f, 0.8f) * 0.3f;
	scene.material[0].n = 64.0f;

	scene.material[0].k_t = Color(0.0f, 0.0f, 0.0f);
	scene.material[0].k_tg = Color(0.0f, 0.0f, 0.0f);
	scene.material[0].m = 0.0f;
	scene.material[0].u = 1.0f;

	// Light green - reflective
	scene.material[1].k_d = Color(0.4f, 0.8f, 0.4f);
	scene.material[1].k_a = scene.material[0].k_d;
	scene.material[1].k_r = Color(0.8f, 0.8f, 0.8f) * 0.6f;
	scene.material[1].k_rg = Color(0.8f, 0.8f, 0.8f) * 0.3f;
	scene.material[1].n = 64.0f;
	...
	scene.material[2].k_d = Color(0.4f, 0.4f, 0.8f) * 0.9f;
	scene.material[2].k_a = scene.material[0].k_d;
	scene.material[2].k_r = Color(0.8f, 0.8f, 0.8f) * 0.6f;
	scene.material[2].k_rg = Color(0.8f, 0.8f, 0.8f) * 0.3f;
	scene.material[2].n = 64.0f;
	...
	scene.material[3].k_d = Color(0.6f, 0.6f, 0.2f);
	scene.material[3].k_a = scene.material[0].k_d;
	scene.material[3].k_r = Color(0.8f, 0.8f, 0.8f) * 0.6f;
	scene.material[3].k_rg = Color(0.8f, 0.8f, 0.8f) * 0.3f;
	scene.material[3].n = 64.0f;
	...
	scene.material[4].k_d = Color(0.6f, 0.6f, 0.6f);
	scene.material[4].k_a = scene.material[0].k_d;
	scene.material[4].k_r = Color(0.6f, 0.6f, 0.6f) * 0.0f;
	scene.material[4].k_rg = Color(0.8f, 0.8f, 0.8f) * 0.0f;
	scene.material[4].n = 16.0f;
	...
	// "Bubble" - transparent
	scene.material[5].k_d = Color(1.0f, 1.0f, 1.0f) * 0.2f;
	scene.material[5].k_a = scene.material[5].k_d;
	scene.material[5].k_r = Color(0.8f, 0.8f, 0.8f) * 0.5f;
	scene.material[5].k_rg = Color(0.8f, 0.8f, 0.8f) * 0.4f;
	scene.material[5].n = 64.0f;

	// k_r and k_t should be computed by fresnel equation for more realistic result: k_t = (1-k_r)
	scene.material[5].k_t = Color(0.8f, 0.8f, 0.8f) * 0.9f;
	scene.material[5].k_tg = Color(0.8f, 0.8f, 0.8f) * 0.9f;
	scene.material[5].m = 64.0f;
	scene.material[5].u = REFRACTION_BUBBLE; // "Bubble" refraction index

	// Glass - transparent
	scene.material[6].k_d = Color(1.0f, 1.0f, 1.0f) * 0.2f;
	scene.material[6].k_a = scene.material[5].k_d;
	scene.material[6].k_r = Color(0.8f, 0.8f, 0.8f) * 0.6f;
	scene.material[6].k_rg = Color(0.8f, 0.8f, 0.8f) * 0.5f;
	scene.material[6].n = 64.0f;

	scene.material[6].k_t = Color(0.8f, 0.8f, 0.8f) * 0.9f;
	scene.material[6].k_tg = Color(0.8f, 0.8f, 0.8f) * 0.9f;
	scene.material[6].m = 64.0f;
	scene.material[6].u = REFRACTION_GLASS; // Glass refraction index
	...
	scene.surfacep[0] = new Plane(Vector3d(0.0, 1.0, 0.0), Vector3d(0.0, 0.0, 0.0), &(scene.material[2])); // Horizontal plane.
	scene.surfacep[1] = new Plane(Vector3d(1.0, 0.0, 0.0), Vector3d(-50.0, 0.0, 0.0), &(scene.material[1])); // Left vertical plane.
	scene.surfacep[2] = new Plane(Vector3d(0.0, 0.0, 1.0), Vector3d(0.0, 0.0, -100.0), &(scene.material[4])); // Right vertical plane.
	scene.surfacep[3] = new Sphere(Vector3d(0.0, 30.0, 10.0), 15.0, &(scene.material[1])); // Big sphere.
	scene.surfacep[4] = new Sphere(Vector3d(-10.0, 20.0, 40.0), 12.0, &(scene.material[0])); // Small sphere.
	scene.surfacep[5] = new Sphere(Vector3d(10.0, 40.0, -10.0), 7.0, &(scene.material[1])); // Small sphere.
	scene.surfacep[6] = new Sphere(Vector3d(0.0, 20.0, -40.0), 7.0, &(scene.material[3])); // Small sphere.
	scene.surfacep[7] = new Sphere(Vector3d(20.0, 20.0, 40.0), 7.0, &(scene.material[1])); // Small sphere.
	scene.surfacep[8] = new Sphere(Vector3d(20.0, 20.0, -40.0), 7.0, &(scene.material[2])); // Small sphere.
	scene.surfacep[9] = new Sphere(Vector3d(30.0, 45.0, 50.0), 12.0, &(scene.material[5])); // Transparent air sphere
	scene.surfacep[10] = new Sphere(Vector3d(20.0, 35.0, -20.0), 6.0, &(scene.material[6])); // Refracting glass sphere


	// Define cameras
	// Front camera
	scene.camera = Camera(Vector3d(120.0, 120.0, 120.0), Vector3d(45.0, 50.0, 55.0), Vector3d(0.0, 1.0, 0.0), (-1.0 * imageWidth) / imageHeight, (1.0 * imageWidth) / imageHeight, -1.0, 1.0, 3.0, imageWidth, imageHeight);
	
	// From left
	//scene.camera = Camera(Vector3d(80.0, 100.0, 130.0), Vector3d(25.0, 40.0, 40.0), Vector3d(0.0, 1.0, 0.0), (-1.0 * imageWidth) / imageHeight, (1.0 * imageWidth) / imageHeight, -1.0, 1.0, 3.0, imageWidth, imageHeight);
